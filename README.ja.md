...
現在の日本語版チャーター（`LMR_AI_Charter_private_public_v0.1_ja.md`）には、`ai-lmr-guard v0.4` の実運用フィードバックを第9章として反映しています。
...
- 現在の公開版: `v0.1`（日本語版は第9章に `v0.4` フィードバックを追補）
